...
{
    public partial class usrReleaseStatistics : DevExpress.XtraEditors.XtraForm
    {
        ...
        public usrReleaseStatistics()
        {
            ...
            _dt.Columns.Add(new DataColumn("AVG_PRICE", typeof(long)));
            ...
            _dtDetail.Columns.Add(new DataColumn("PRICE", typeof(long)));
            _dtDetail.Columns.Add(new DataColumn("SA", typeof(int)));
            _dtDetail.Columns.Add(new DataColumn("SACNT", typeof(int)));
            ...
            _dtDetail.Columns.Add(new DataColumn("CAPTURE_YN", typeof(int)));
            _dtDetail.Columns.Add(new DataColumn("COMPONENT_CD", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("PRODUCT_YN", typeof(int)));
            ...
            _dtDetail.Columns.Add(new DataColumn("CPU_MODEL_NAME", typeof(string)));

            _dtDetail.Columns.Add(new DataColumn("MEM_MANUFACT1", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_CAPACITY1", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_MANUFACT2", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_CAPACITY2", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_MANUFACT3", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_CAPACITY3", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_MANUFACT4", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MEM_CAPACITY4", typeof(string)));

            _dtDetail.Columns.Add(new DataColumn("VGA_MODEL_NAME1", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("VGA_MODEL_NAME2", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("STG_TYPE1", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("STG_CAPACITY1", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("STG_TYPE2", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("STG_CAPACITY2", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("MON_SIZE", typeof(string)));

            _dtDetail.Columns.Add(new DataColumn("ODD", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("CAM", typeof(int)));
            _dtDetail.Columns.Add(new DataColumn("WIFI", typeof(int)));
            _dtDetail.Columns.Add(new DataColumn("BATTERY", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("OS_NAME", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("REMARKS1", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("REMARKS2", typeof(string)));

            _dtDetail.Columns.Add(new DataColumn("LICENCE", typeof(string)));
            _dtDetail.Columns.Add(new DataColumn("STATE", typeof(int)));
            _dtDetail.Columns.Add(new DataColumn("CHECK", typeof(bool)));
            ...
            _dtProductDetail.Columns.Add(new DataColumn("CAPTURE_FILE_ID", typeof(long)));
        ...
        private void getVCols()
        {
            if (ProjectInfo._userType.Equals("M") || ProjectInfo._userType.Equals("S") || ProjectInfo._userType.Equals("G"))
            {
                ...
                gcPrice2.Visible = true;
                gcAvgPrice.Visible = true;
            }
            else
            {
                gcPrice.Visible = false;
                gcPrice1.Visible = false;
                gcPrice2.Visible = false;
                gcAvgPrice.Visible = false;
            }
        }
        ...
        private void geList()
        {
            ...
            foreach (DataRow row in rows)
            {
                ...
                jobj.Add("EXPORT_ID", ConvertUtil.ToInt64(row["EXPORT_ID"]));
                jobj.Add("ARRIVAL_DT", ConvertUtil.ToString(row["ARRIVAL_DT"]));
                jArr.Add(jobj);
            }
            ...
            if (DBRelease.getExportStatistics(jData, ref jResult))
            {
                ...
                if (Convert.ToBoolean(jResult["PRODUCT_STATISTICS_EXIST"]))
                {
                    ...
                    foreach (JObject obj in jArray.Children<JObject>())
                    {
                        ...
                        dr["CPU_MODEL_NAME"] = obj["CPU_INFO"];
                ...
                if (Convert.ToBoolean(jResult["PART_STATISTICS_EXIST"]))
                {
                    ...
                    foreach (JObject obj in jArray.Children<JObject>())
                    {
                        ...
                        //{
                        //    dr["MBD_MANUFACT"] = $"{obj["MANUFACTURE_NM"]}/{obj["SPEC_NM"]}";
                        //    dr["PRODUCT_NAME"] = obj["COL1"];
                        //}
        ...
        private void rgDt_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.gcReleaseDt.VisibleIndex = 1;
                    this.gcArrivalDt.VisibleIndex = 2;
                    gvList.ClearSorting();
                ...
                else
                {
                    ...
                    this.gcArrivalDt.VisibleIndex = 1;
        ...
        private void lcgReleaseDetail_CustomButtonClick(object sender, DevExpress.XtraBars.Docking2010.BaseButtonEventArgs e)
        {
            using (SaveFileDialog form = new SaveFileDialog())
            {
                form.Filter = "Excel 통합문서|*.xlsx";
