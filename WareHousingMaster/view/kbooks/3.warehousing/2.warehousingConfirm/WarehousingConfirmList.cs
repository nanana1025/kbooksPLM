...
{
    public partial class WarehousingConfirmList : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void gvList_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            if (_currentRow != null)
            {
                if (e.Column.FieldName != "CHECK")
                {
                    ...
                    else if (e.Column.FieldName == "ORDER_RATIO")
                    {
                        _currentRow["ORDER_RATIO"] = e.Value;
                    }
                }
            }
        }
        ...
        private void rileOrderRatio_EditValueChanged(object sender, EventArgs e)
        {
            ...
            _currentRow["ORDER_RATIO"] = ConvertUtil.ToInt32(editor.EditValue);
