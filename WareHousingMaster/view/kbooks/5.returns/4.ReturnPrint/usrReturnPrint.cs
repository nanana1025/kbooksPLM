...
{
    public partial class usrReturnPrint : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void usrForm_Load(object sender, EventArgs e)
        {
            ...
            //usrReturnPrintSearch1.searchHandler += new usrModifReturnSearch.SearchHandler(searchList);
            //usrReturnPrintSearch1.clearHandler += new usrModifReturnSearch.ClearHandler(clear);



            //usrReturnPrintSearch1.confirmHandler += new usrModifReturnSearch.ConfirmHandler(confirmHandler);
            //usrReturnPrintSearch1.searchPerformanceHandler += new usrModifReturnSearch.SearchPerformanceHandler(searchPerformanceHandler);
            //usrReturnPrintSearch1.deleteRowHandler += new usrModifReturnSearch.DeleteRowHandler(deleteRowHandler);
        ...
        {
            usrReturnPrintSearch1.setInitLoad();
        ...
        private void processHandler(int F)
        {
            switch (F)
            {
                ...
                case 6:
                    break;
                case 7:
                    usrReturnPrintSearch1.clear();
                    //usrModifReturnList1.setTableInitialize();
                    usrReturnPrintSearch1.setFocus();
                    break;
                case 8:
                    confirmHandler();
                    break;
