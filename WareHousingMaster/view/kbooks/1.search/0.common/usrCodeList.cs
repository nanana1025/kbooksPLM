...
{
    public partial class usrCodeList : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public usrCodeList()
        {
            ...
            _dt.Columns.Add(new DataColumn("CODE_CD", typeof(int)));
            _dt.Columns.Add(new DataColumn("CODE_NM", typeof(string)));
        ...
        public void getList(JObject jobj, int type = 1)
        {
            _jobj = jobj;

            JObject jResult = new JObject();
            string url = "/common/getKbooksCodeList.json";
            if (type == 1)
                url = "/common/getKbooksCodeList.json";
            else
                url = "/common/getKbooksProductCodeList.json";
            ...
            if (DBConnect.getRequest(jobj, ref jResult, url))
            {
                if (Convert.ToBoolean(jResult["EXIST"]))
                {
                    ...
                    foreach (JObject obj in jArray.Children<JObject>())
                    {
                        ...
                        dr["NO"] = index++;
                        dr["CODE_CD"] = ConvertUtil.ToInt32(obj["CODE_CD"]);
                        dr["CODE_NM"] = ConvertUtil.ToString(obj["CODE_NM"]);
        ...
        public DataRowView getDataRowView()
        {
            return _currentRow;
        }
