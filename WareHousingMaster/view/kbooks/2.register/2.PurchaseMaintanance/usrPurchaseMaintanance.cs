...
{
    public partial class usrPurchaseMaintanance : DevExpress.XtraEditors.XtraForm
    {
        long _bookCd;
        int _shopCd;
        bool _isEditable;
        ...
        private void usrForm_Load(object sender, EventArgs e)
        {
            ...
            usrPurchaseMaintananceDetail1.buttonHandler += new usrPurchaseMaintananceDetail.ButtonHandler(buttonHandler);
            usrSideCheck1.processHandler += new usrSideCheck.ProcessHandler(processHandler);
            

            setInitialize(_isEditable);
            usrPurchaseMaintananceDetail1.setInitLoad();
            //getBookInfo();
        }
        ...
        private void processHandler(int F)
        {
            ...
            {
                case 1:
                    usrPurchaseMaintananceDetail1.InsertPurchaseInfo();
                    break;
                case 2:
                    usrPurchaseMaintananceDetail1.UpdatePurchaseInfo();
                    break;
                case 3:
                    usrPurchaseMaintananceDetail1.DeletePurchaseInfo();
                    break;
                case 4:
                    break;
                case 5:
                ...
                case 6:
                    break;
                case 7:
                    usrPurchaseMaintananceDetail1.clear();
                    break;
                case 8:
                    break;
                case 9:
