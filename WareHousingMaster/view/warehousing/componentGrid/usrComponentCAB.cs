...
{
    public partial class usrComponentCAB : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void setinitialize()
        {
            ...
            foreach (string col in ProjectInfo._dicDeviceFullColumn["CAB"])
