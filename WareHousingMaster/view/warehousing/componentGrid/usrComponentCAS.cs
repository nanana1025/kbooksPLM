...
{
    public partial class usrComponentCAS : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void setinitialize()
        {
            ...
            foreach (string col in ProjectInfo._dicDeviceFullColumn["CAS"])
