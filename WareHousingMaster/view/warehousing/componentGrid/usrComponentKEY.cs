...
{
    public partial class usrComponentKEY : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void setinitialize()
        {
            ...
            foreach (string col in ProjectInfo._dicDeviceFullColumn["KEY"])
