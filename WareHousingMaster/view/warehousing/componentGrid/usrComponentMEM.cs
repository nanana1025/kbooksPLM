...
{
    public partial class usrComponentMEM : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void setinitialize()
        {
            ...
            foreach (string col in ProjectInfo._dicDeviceFullColumn["MEM"])
                _dt.Columns.Add(new DataColumn(col, typeof(string)));
            _dt.Columns.Add(new DataColumn("PC_TYPE", typeof(string)));
        ...
        private void gvPart_FocusedRowObjectChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowObjectChangedEventArgs e)
        {
            ...
            if (isValidRow)
            {
                ...
                //_adpType = rileType.GetDisplayValueByKeyValue(_currentRow["ADP_CAT"]).ToString();
            }
        }
    }
}
