...
{
    public partial class usrComponentMBD : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void setinitialize()
        {
            ...
            foreach (string col in ProjectInfo._dicDeviceFullColumn["MBD"])
