...
{
    public partial class DlgVideoPlayer : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            string fileName = $"{System.Windows.Forms.Application.StartupPath}\\Seoul.avi";
        ...
        private void openMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == openFileDialog.ShowDialog())
            {
                ...
                this.Text = "동영상 재생 - [" + openFileDialog.FileName + "]";
