...
{
    public partial class usrConsignedAdjustment_TEMP : DevExpress.XtraEditors.XtraForm
    {
        ...
        DataTable _dtConsignedExchangeDetail;
        DataTable _dtConsignedRefundDetail;
        DataTable _dtConsignedDetail;
        BindingSource bsConsignedAdjustMentSumary;
        BindingSource bsConsignedtDetail;
        ...
        public usrConsignedAdjustment_TEMP()
        {
            InitializeComponent();
            ...
            _dtConsignedAdjustMentSumary.Columns.Add(new DataColumn("LT_CNT", typeof(int)));
            _dtConsignedAdjustMentSumary.Columns.Add(new DataColumn("LT_PRICE", typeof(long)));
            ...
            _dtConsignedRefundDetail = new DataTable();

            _dtConsignedRefundDetail.Columns.Add(new DataColumn("TYPE", typeof(string)));
            _dtConsignedRefundDetail.Columns.Add(new DataColumn("NAME", typeof(string)));
            _dtConsignedRefundDetail.Columns.Add(new DataColumn("MODEL", typeof(string)));
            _dtConsignedRefundDetail.Columns.Add(new DataColumn("PRICE", typeof(long)));
            _dtConsignedRefundDetail.Columns.Add(new DataColumn("CNT", typeof(int)));
            _dtConsignedRefundDetail.Columns.Add(new DataColumn("TOTAL_PRICE", typeof(long)));

            _dtConsignedExchangeDetail = new DataTable();

            _dtConsignedExchangeDetail.Columns.Add(new DataColumn("TYPE", typeof(string)));
            _dtConsignedExchangeDetail.Columns.Add(new DataColumn("NAME", typeof(string)));
            _dtConsignedExchangeDetail.Columns.Add(new DataColumn("MODEL", typeof(string)));
            _dtConsignedExchangeDetail.Columns.Add(new DataColumn("PRICE", typeof(long)));
            _dtConsignedExchangeDetail.Columns.Add(new DataColumn("CNT", typeof(int)));
            _dtConsignedExchangeDetail.Columns.Add(new DataColumn("TOTAL_PRICE", typeof(long)));
            ...
            bsConsignedtDetail = new BindingSource();
        ...
        private void setIInitData()
        {
            ...
            bsConsignedtDetail.DataSource = _dtConsignedDetail;
            gcConsignedDetail.DataSource = bsConsignedtDetail;
        ...
        private void radioGroup1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    bsConsignedtDetail.DataSource = _dtConsignedProductDetail;
            //else if (ConvertUtil.ToInt32(rgType.EditValue) == 2)
            //    bsConsignedtDetail.DataSource = _dtConsignedPartDetail;
            //else if (ConvertUtil.ToInt32(rgType.EditValue) == 3)
            //    bsConsignedtDetail.DataSource = _dtConsignedProduceDetail;
            //else if (ConvertUtil.ToInt32(rgType.EditValue) == 4)
            //    bsConsignedtDetail.DataSource = _dtConsignedDeliveryDetail;
            //else if (ConvertUtil.ToInt32(rgType.EditValue) == 5)
            //    bsConsignedtDetail.DataSource = _dtConsignedRefundDetail;

            //gcConsignedDetail.DataSource = bsConsignedtDetail;

            if (ConvertUtil.ToInt32(rgType.EditValue) == 0)
                bsConsignedtDetail.Filter = $"CATEGORY > 0";
            else
                bsConsignedtDetail.Filter = $"CATEGORY = {rgType.EditValue}";
        ...
        private bool getSummaryList()
        {
            ...
            if (DBConnect.getConsignedAdjustmentSummary(jobj, ref jResult))
            {
                ...
                dr1["LT_CNT"] = 0;
                dr1["LT_PRICE"] = 0;
                dr1["TOTAL_PRICE"] = jData["PRODUCT_PRICE"];
                ...
                dr2["LT_CNT"] = 0;
                dr2["LT_PRICE"] = 0;
                dr2["TOTAL_PRICE"] = jData["PART_PRICE"];
                ...
                dr3["LT_CNT"] = 0;
                dr3["LT_PRICE"] = 0;
                dr3["TOTAL_PRICE"] = jDataP["PRODUCE_PRICE"];
                ...
                dr4["LT_CNT"] = 0;
                dr4["LT_PRICE"] = 0;
                dr4["TOTAL_PRICE"] = jDataP["DEILIVERY_PRICE"];
                _dtConsignedAdjustMentSumary.Rows.Add(dr4);

                JObject jDataR = (JObject)jResult["REFUND"];

                DataRow dr5 = _dtConsignedAdjustMentSumary.NewRow();
                dr5["TYPE"] = "기타";
                dr5["CNT"] = 0;
                dr5["PRICE"] = 0;
                dr5["LT_CNT"] = jDataR["PRICE_CNT"];
                dr5["LT_PRICE"] = ConvertUtil.ToInt64(jDataR["PRICE_PRICE"]) * -1;
                dr5["TOTAL_PRICE"] = ConvertUtil.ToInt64(jDataR["PRICE_PRICE"]) * -1;
                _dtConsignedAdjustMentSumary.Rows.Add(dr5);
        ...
        private bool setConsignedDetail(JObject jobj)
        {
            ...
            _dtConsignedExchangeDetail.Clear();
            _dtConsignedRefundDetail.Clear();
...
- {refundCustomer}";
        ...
        private void Root2_CustomButtonClick(object sender, DevExpress.XtraBars.Docking2010.BaseButtonEventArgs e)
        {
            if (e.Button.Properties.Tag.Equals(1))
            {
                using (SaveFileDialog form = new SaveFileDialog())
