...
namespace WareHousingMaster.view.common
{
    static class Dangol
    {
        ...
        {
            MessageBox.Show(msg, "ERP");
        }

        static public void Message(object msg)
        {
            MessageBox.Show(ConvertUtil.ToString(msg), "ERP");
        }
        ...
        {
            MessageBox.Show(ConvertUtil.ToString(msg), "ERP", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }

        static public void Error(object msg)
        {
            MessageBox.Show(ConvertUtil.ToString(msg), "ERP", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        static public void ShowSplash(string title = "", string content = "Wait...")
        {
        ...
        static public void setSplashContent(string title = "", string content = "Wait...")
        {
            SplashScreenManager.Default.SetWaitFormCaption(title);
            SplashScreenManager.Default.SetWaitFormDescription(content);
        }
